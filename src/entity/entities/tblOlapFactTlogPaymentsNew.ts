...
@Entity("tbl_olap_fact_tlogPayments_NEW",{schema:"dbo"})
@Index("csix_siteId_businessDate",["siteId","businessDate",])
@Index("ix_siteId_businessDate",["siteId","businessDate",])
@Index("uci_id",["id",],{unique:true})
export class tblOlapFactTlogPaymentsNew {
