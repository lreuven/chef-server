...
@Entity("tbl_olap_fact_tlogSales_NEW",{schema:"dbo"})
@Index("ci_id",["id",])
@Index("ci_itemId",["itemId",])
@Index("ci_orderedItemId",["orderedItemId",])
@Index("csix_siteId_businessDate_itemId",["siteId","businessDate","itemId",])
@Index("id_businessDate",["businessDate",])
@Index("ix_siteId_businessDate",["siteId","businessDate",])
@Index("ix_tlogId",["tlogId",])
export class tblOlapFactTlogSalesNew {
