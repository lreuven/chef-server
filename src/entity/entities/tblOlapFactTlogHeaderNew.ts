...
@Entity("tbl_olap_fact_tlogHeader_NEW",{schema:"dbo"})
@Index("ix_jsonCreatedApi",["jsonCreatedApi",])
@Index("ix_siteId_businessDate",["siteId","businessDate",])
@Index("ix_tlogId",["tlogId","siteId","businessDate","zNumber","groupSize","timeOffset","opened","openedDateKey","openedHourKey","closed","closedDateKey","closedHourKey","lastPaymentTime","lastPaymentTimeDateKey","lastPaymentTimeHourKey","loyalty","ownerId","isStaff","allGeneral","source","orderNumber","deviceName","serviceName","serviceTime","serviceKey","orderType","totalTime","diners","customerCount","orderCount","vatPercent","excludedTaxAmount","totalAmount","totalPaymentAmount","totalSalesAmount","totalTipAmount","declaredTipAmount","totalBeforeTip","totalForTip","totalIncludedTax","totalExcludedTax","exemptedExcludedTax","exemptedIncludedTax","totalExemptedTax","totalReductionAmount","vatAmount","taxs","olapPartition","tableId","tableseats","tablenumber","tlogCreated","tlogCreatedKey","tlogCreatedHourKey","processingStatus","closedToProcessingStartTime","processingStartTimeToTlogCreated","tlogProcessTime","workflowProfileId","workflowProfileName","workflowProfileType","dcTlogId","deliveryPersonId","mainPhoneNumber","locationLat","locationLng","ordererEmail","ordererRegionName","externalSource","jsonCreatedApi",])
@Index("ix_tlogId2",["tlogId",])
export class tblOlapFactTlogHeaderNew {
