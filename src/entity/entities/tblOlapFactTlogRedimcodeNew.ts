...
@Entity("tbl_olap_fact_tlogRedimcode_NEW",{schema:"dbo"})
@Index("ci_tlogId_promotionId_externalId",["tlogId","promotionId","externalId",])
export class tblOlapFactTlogRedimcodeNew {
